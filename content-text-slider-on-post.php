...
Plugin URI: http://www.gopipulse.com/work/2012/01/02/content-text-slider-on-post-wordpress-plugin/
Description: Content text slider on post is a WordPress plugin from gopipulse.com website. We can use this plugin to scroll the content vertically in the posts and pages. We have option to enter content title, description and link for the content. All entered details scroll vertically into the posts and pages.
Author: Gopi.R
Version: 4.0
Author URI: http://www.gopipulse.com/work/2012/01/02/content-text-slider-on-post-wordpress-plugin/
Donate link: http://www.gopipulse.com/work/2012/01/02/content-text-slider-on-post-wordpress-plugin/
...
function ctsop_install() 
{
	...
	if($wpdb->get_var("show tables like '". WP_ctsop_TABLE . "'") != WP_ctsop_TABLE) 
	{
		...
		$DummyLink = "http://www.gopipulse.com/work/";
